public static int PrintingCosts2(String Line) {
        int totalCost = 0;
        String costs = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_abcdefghijklmnopqrstuvwxyz{|}~";
        ...
        16, 22, 18, 20, 25, 25, 13, 21, 17, 17, 13, 19, 13, 24, 19, 18, 12, 18, 18, 9};
